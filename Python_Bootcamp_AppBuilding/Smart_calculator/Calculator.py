    ...
    for word in text.split(" "):
        if word.upper() in operations.keys():
            try:
                ...
                list.delete(0,END)
                list.insert(END,"soething went wrong please enter again")
            finally:
                break
...
list = Listbox(win,width = 28, height = 3)
list.place(x = 110, y = 230)
