...
# Egg creator
egg_color = cycle(["light blue","light pink","light yellow","light green","green","red","blue","black"])
egg_width = 45
egg_height = 55
egg_score = 10
egg_speed = 500
# 4 second between the creations of each eggs
egg_interval = 4000
...
# Create the falling eggs
eggs = []
def create_eggs():
    x = randrange(10,740)
    y = 40
    new_egg = c.create_oval(x, y, x + egg_width, y + egg_height,fill = next(egg_color), width = 0)
    eggs.append(new_egg)
