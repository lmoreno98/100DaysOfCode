...
Conector MySQL de PowerBI:
https://dev.mysql.com/downloads/connector/odbc/

a. Chequear estas variables en la consola de MYSQL.
show global variables like 'local_infile';
show variables like "secure_file_priv";

b. Copiar los files del curso a la carpeta del servidor identificada en el paso A.

---------------------------------
1.Crear base de datos con workbench: baseventas
2.
REEMPLAZAR 
	LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
POR
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Datos_Procesados_Para_Subir\\venta.csv' 

(idventa, fecha,fecha_entrega,idcanal,idcliente,idsucursal,idempleado,
idproducto,@precio,@cantidad)
set cantidad = nullif(@cantidad,0),
precio = nullif(@precio,0);
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Datos_Procesados_Para_Subir\\gasto.csv' 
INTO TABLE gasto 
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Datos_Procesados_Para_Subir\\compra.csv' 
INTO TABLE compra 
FIELDS TERMINATED BY ',' ENCLOSED BY '' ESCAPED BY '' 
LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Datos_Procesados_Para_Subir\\CanalDeVenta.csv' 
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Datos_Procesados_Para_Subir\\TiposDeGasto.csv' 
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Datos_Procesados_Para_Subir\\Clientes.csv'
INTO TABLE cliente
FIELDS TERMINATED BY ';' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Datos_Procesados_Para_Subir\\Proveedores.csv' 
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Datos_Procesados_Para_Subir\\Productos.csv' 
INTO TABLE producto 
FIELDS TERMINATED BY ',' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Datos_Procesados_Para_Subir\\Empleados.csv' 
INTO TABLE empleado 
FIELDS TERMINATED BY ',' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
...
LOAD DATA INFILE 'C:\\xampp\\tmp\\Datos_Procesados_Para_Subir\\Sucursales.csv' 
INTO TABLE sucursal
FIELDS TERMINATED BY ';' ENCLOSED BY '\"' ESCAPED BY '\"' 
LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
